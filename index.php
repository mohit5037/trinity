...
<html lang="en" class="no-js"> <!--<![endif]-->
    ...
    <body>
        ...
        <div class="inner">
            ...
            <p>Follow Us On</p>  
            <ul>
                    <li ><a href="http://www.facebook.com" class="iconfb">Facebook</a></li>
                    <li><a href="https://twitter.com/" class="icontwit">Twitter</a></li>
                    <li><a href="https://plus.google.com/" class="icongp">Google Plus</a></li>
            </ul>
        </div>
    </div>
        <div id="header">       
        ...
        <div id="small_parent">
        <div id="wrapper">
                        <div id="login" class="animate_form">
                            <form  action="<?php $_PHP_SELF ?>" autocomplete="on" method="post"> 
                                 
                                <p> 
                                    <label for="username" class="uname" data-icon="u" > Your Username </label>
                                    <input id="username" name="username" required="required" type="email" placeholder="myusername@icoupons.com"/>
                                </p>
                                <p> 
                                ...
                                <p class="change_link">
                                    Not a member yet ?
                                    <a href="newmerchant.php" class="to_register">Join us</a>
                                </p>
                            </form>
                        </div>
                        ...
                        <div id="register" class="animate form">
                            <form  action="" autocomplete="on" method="post"> 
                                <h1>iCoupons Merchant<br>Sign Up </h1> 
                                <p> 
                               ...
                               <p> 
                                ...
                                <p class="change_link">  
									Already a member ?
									<a href="newmerchant.php" class="to_register"> Go and log in </a>
								</p>
                            </form>
                        </div>
						</div>
